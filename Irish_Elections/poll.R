...
py_run_file("Irish_Elections/data.py")
poll <- read_csv("Irish_Elections/poll.csv")
...
ggsave(plot=plot, file="Irish_Elections/plot.png",width = 15, height = 7.5,type="cairo-png")
