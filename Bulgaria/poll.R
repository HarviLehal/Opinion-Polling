...
d7 <-dplyr::bind_rows(d0,d1,d2,d3,d4,d5,d6)
...
plot2<-ggplot(data=d7, aes(x=variable, y=value,fill=interaction(Date,variable), group=Date )) +
  ...
  scale_fill_manual(values = c("#99bbdb","#99bbdb","#6698ca","#4d87c1","#3376b8","#1a65af","#0054a6",
                               "#a180ff","#a180ff","#8e66ff","#7b4dff","#6833ff","#551aff","#4200ff",
                               "#f0d09a","#f0d09a","#e4c386","#dbba7d","#d2b174","#c9a86b","#c09f62",
                               "#99a3ed","#99a3ed","#668adc","#4d81d2","#3378c9","#1a6fc0","#0066b7",
                               "#ff4e69","#ff4e69","#ff3954","#f92f49","#f0243e","#e61a33","#db0f28",
                               "#a6e6ff","#a6e6ff","#87ddff","#78d4f9","#69cbf0","#5ac2e7","#4bb9de",
                               "#7eaa71","#7eaa71","#5d9556","#4c8c4d","#3b8344","#2a7a3b","#197032",
                               "#f16c9a","#f16c9a","#e34c78","#d93d67","#cf2e56","#c51f45","#ba1034",
                               "#d9d9d9","#d9d9d9","#c1c1c1","#b7b7b7","#adadad","#a3a3a3","#999999",
                               "#fff599","#fff599","#ffe866","#ffdf4d","#ffd533","#ffcc1a","#ffc300",
                               "#4d9fd1","#4d9fd1","#328aba","#267aad","#1a6a9e","#0e5a8f","#004a80",
                               "#f16c9a","#f16c9a","#e34c78","#d93d67","#cf2e56","#c51f45","#ba1034",
                               "#5ce0c1","#5ce0c1","#3cd7b1","#2dc8a2","#1eb993","#0faa84","#009b75"))+
