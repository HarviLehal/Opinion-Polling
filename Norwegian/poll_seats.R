...
library(hrbrthemes)
library(ggbreak)
poll <- read_csv("Norwegian/poll_seats.csv")
...
plot1<-ggplot(data=d,aes(x=Date,y=value, colour=variable, group=variable)) +
  ...
  scale_y_continuous(name="Vote",breaks=seq(0,60,5))+
...
ggsave(plot=plot, file="Norwegian/plot_seats.png",width = 20, height = 10, type="cairo-png")
