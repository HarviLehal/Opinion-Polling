...
plot1<-ggplot(data=d,aes(x=Date,y=value, colour=variable, group=variable)) +
  ...
  scale_color_manual(values = c("#000000","#009EE0","#BE3075",
                                "#46962b","#E3000F","#ffed00",
                                "#792350","#888888"))+
  ...
  geom_smooth(method="loess",fullrange=FALSE,se=FALSE,span=0.8,linewidth=0.75, data=new2[new2$Date!=old,])+
  theme_minimal()+
  ...
  ggtitle('Opinion Polling for the 2024 Saxony State Election')
plot1
...
plot2<-ggplot(data=d3, aes(x=variable, y=value,fill=interaction(Date,variable), group=Date )) +
  ...
  scale_fill_manual(values = c("#6686ad","#10305B","#66c5ec","#009EE0",
                               "#dba2b6","#B43377","#9bcca1","#509A3A",
                               "#f08490","#DD1529","#fadc7d","#FBBE00",
...
ggsave(plot=plot, file="German/State/Saxony/plot.png",width = 15, height = 7.5, type = "cairo-png")
