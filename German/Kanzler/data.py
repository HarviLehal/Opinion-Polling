...
headers = ['1','Date','2','Scholz','Merz','Habeck','Neither']
parties = ['Scholz','Merz','Habeck','Neither']
drops = ['1','2']
d = {}
for i in range(1):
...
D.to_csv('German/Kanzler/polla.csv', index=False)
...
print(D)
parties = ['Scholz','Merz','Habeck']
D[parties] = D[parties].div(D['decided'], axis=0)*100

D = D.drop(["decided","total","Neither"], axis=1)

D.to_csv('German/Kanzler/poll2a.csv', index=False)
