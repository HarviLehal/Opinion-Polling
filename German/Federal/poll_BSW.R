...
library(data.table)
library(hrbrthemes)
py_run_file("German/Federal/data_BSW.py")
poll <- read_csv("German/Federal/poll_BSW.csv")
...
ggsave(plot=plot, file="German/Federal/plot_BSW.png",width = 15, height = 7.5, type="cairo-png")

# plot<-ggarrange(plot3, plot2,ncol = 2, nrow = 1,widths=c(2,0.5))
# plot
# ggsave(plot=plot, file="German/Federal/plot2_BSW.png",width = 15, height = 7.5, type="cairo-png")
