...
library(data.table)
library(hrbrthemes)
poll <- read_csv("German/Federal/poll2.csv")
...
plot1<-ggplot(data=d,aes(x=Date,y=value, colour=variable, group=variable)) +
  ...
  scale_color_manual(values = c("#B43377","#DD1529","#10305B"))+
...
ggsave(plot=plot, file="German/Federal/plot_govt.png",width = 15, height = 7.5, type="cairo-png")

plot<-ggarrange(plot3, plot2,ncol = 2, nrow = 1,widths=c(2,0.5))
plot
ggsave(plot=plot, file="German/Federal/plot2_govt.png",width = 15, height = 7.5, type="cairo-png")
