...
py_run_file("French/Approval_Ratings/data.py")
macron <- read_csv("French/Approval_Ratings/macron.csv")
borne <- read_csv("French/Approval_Ratings/borne.csv")
...
ggsave(plot=plot, file="French/Approval_Ratings/plot.png",width = 15, height = 7.5, type = "cairo-png")
