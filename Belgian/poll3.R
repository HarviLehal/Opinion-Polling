...
plot1<-ggplot(data=d,aes(x=Date,y=value, colour=variable, group=variable)) +
  ...
  scale_color_manual(values = c("#0047ab","#ff0000","#8b0000",
                                "#5aad39","#40e0d0","#dd0081",
                                "#5d50a4","#e0b917","#e6ce00","#999999"))+
  ...
  ggtitle('Sondages sur les élections fédérales belges (Bruxelles-Captiale)')
...
plot2<-ggplot(data=d4, aes(x=variable, y=value,fill=interaction(Date,variable), group=Date )) +
  ...
  scale_fill_manual(values = c("#6691cd","#0047ab","#ff6666","#ff0000",
                               "#b96666","#8b0000","#9cce88","#5aad39",
                               "#8cece3","#40e0d0","#eb66b3","#dd0081",
                               "#9e96c8","#5d50a4","#ecd574","#e0b917",
                               "#f0e266","#e6ce00","#c2c2c2","#999999"))+
...
plot
ggsave(plot=plot, file="Belgian/plot_brussel.png",width = 15, height = 7.5, type="cairo-png")
