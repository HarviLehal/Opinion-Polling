...
plot1<-ggplot(data=d,aes(x=Date,y=value, colour=variable, group=variable)) +
  ...
  geom_smooth(method="loess",fullrange=TRUE,se=FALSE,span=0.45,linewidth=0.75, data=d[d$Date!=old&d$Date!=election,])+
  # bbplot::bbc_style()+
...
plot1
ggsave(plot=plot1, file="Belgian/plot_vlaanderen.png",width = 15, height = 7.5, type="cairo-png")
...
plot2
ggsave(plot=plot2, file="Belgian/plot_wallonie.png",width = 15, height = 7.5, type="cairo-png")
...
plot3
ggsave(plot=plot3, file="Belgian/plot_brussel.png",width = 15, height = 7.5, type="cairo-png")
