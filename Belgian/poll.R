...
plot1<-ggplot(data=d,aes(x=Date,y=value, colour=variable, group=variable)) +
  ...
  scale_color_manual(values = c("#e0b917","#e6ce00","#ff2900","#ff6200",
                                "#0087dc","#8b0000","#01796f","#999999"))+
  ...
  # ggtitle('Sondages sur les élections fédérales belges (Flandre)')
ggtitle('Peilingen voor de Belgische Federale Verkiezingen (Vlaanderen)')
...
plot2<-ggplot(data=d4, aes(x=variable, y=value,fill=interaction(Date,variable), group=Date )) +
  ...
  scale_fill_manual(values = c("#ecd574","#e0b917","#f0e266","#e6ce00",
                               "#ff7f66","#ff2900","#ffa166","#ff6200",
                               "#66b7ea","#0087dc","#b96666","#8b0000",
                               "#67afa9","#01796f","#c2c2c2","#999999"
                               ))+
  ...
  theme(legend.position = "none",
        ...
        panel.background = element_rect(fill="#FFFFFF",color="#FFFFFF"),
        plot.background = element_rect(fill = "#FFFFFF",color="#FFFFFF"))+
  ggtitle(' Maandelijks Gemiddelde <br> *(2024 Uitslag)*')+
...
plot
ggsave(plot=plot, file="Belgian/plot_vlaanderen.png",width = 15, height = 7.5, type="cairo-png")
