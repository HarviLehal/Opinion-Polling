...
election<-as.Date("09 06 2029", "%d %m %Y")
old <-min(d$Date)
...
plot1<-ggplot(data=d,aes(x=Date,y=value, colour=variable, group=variable)) +
  geom_point(size=1.25, data=d[d$Date!=old&d$Date!=election,],alpha=0.75)+
  scale_color_manual(values = c("#e0b917","#e6ce00","#0047ab","#ff0000","#8b0000",
                                "#40e0d0","#ff2900","#ff6200","#0087dc","#01796f","#5aad39","#dd0081",
                                "#999999"))+
  geom_smooth(method="loess",fullrange=FALSE,se=FALSE,span=2,linewidth=0.75, data=d[d$Date!=old,])+
  theme_minimal()+
  ...
  scale_y_continuous(name="Seats",,breaks=seq(0,150,2))+
...
plot2<-ggplot(data=d4, aes(x=variable, y=value,fill=interaction(Date,variable), group=Date )) +
  ...
  scale_fill_manual(values = c("#ecd574","#e0b917","#f0e266","#e6ce00","#6691cd","#0047ab",
                               "#ff6666","#ff0000","#b96666","#8b0000","#8cece3","#40e0d0",
                               "#ff7f66","#ff2900","#ffa166","#ff6200","#66b7ea","#0087dc",
                               "#67afa9","#01796f","#9cce88","#5aad39","#eb66b3","#dd0081","#c2c2c2","#999999"
                               ))+
  ...
  theme(legend.position = "none",
        ...
        panel.background = element_rect(fill="#FFFFFF",color="#FFFFFF"),
        plot.background = element_rect(fill = "#FFFFFF",color="#FFFFFF"))+
  ggtitle(' Moyenne mensuelle <br> *(Résultats 2024)*')+
...
plot
ggsave(plot=plot, file="Belgian/plot_seats.png",width = 15, height = 7.5, type="cairo-png")
