...
poll <- read_csv("UK/preferred/poll2a.csv")
...
plot2<-ggplot(data=d1, aes(x=variable, y=value,fill=interaction(Date,variable), group=Date )) +
  ...
  scale_fill_manual(values = c("#c70000","#13bece","#999999"))+
...
plot
ggsave(plot=plot, file="UK/preferred/plot2a.png",width = 20, height = 7.5, type = "cairo-png")
