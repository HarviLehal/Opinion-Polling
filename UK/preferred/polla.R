...
poll <- read_csv("UK/preferred/polla.csv")
...
plot2<-ggplot(data=d1, aes(x=variable, y=value,fill=interaction(Date,variable), group=Date )) +
  ...
  scale_fill_manual(values = c("#c70000","#0077b6","#999999"))+
...
plot
ggsave(plot=plot, file="UK/preferred/plota.png",width = 20, height = 7.5, type = "cairo-png")
