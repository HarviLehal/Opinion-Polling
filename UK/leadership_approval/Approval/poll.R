...
ggsave(plot=plot, file="UK/leadership_approval/Approval/sunak.png",width = 15, height = 7.5, type = "cairo-png")



# STARMER

poll <- read_csv("UK/leadership_approval/Approval/starmer.csv")
d <- reshape2::melt(poll, id.vars="Date")
d$value<-as.numeric(d$value)/100
d$value<-formattable::percent(d$value)
...
ggsave(plot=plot, file="UK/leadership_approval/Approval/starmer.png",width = 15, height = 7.5, type = "cairo-png")



# TRUSS

poll <- read_csv("UK/leadership_approval/Approval/truss.csv")
d <- reshape2::melt(poll, id.vars="Date")
d$value<-as.numeric(d$value)/100
d$value<-formattable::percent(d$value)
...
ggsave(plot=plot, file="UK/leadership_approval/Approval/truss.png",width = 15, height = 7.5, type = "cairo-png")



# BORIS

poll <- read_csv("UK/leadership_approval/Approval/boris.csv")
d <- reshape2::melt(poll, id.vars="Date")
d$value<-as.numeric(d$value)/100
d$value<-formattable::percent(d$value)
...
ggsave(plot=plot, file="UK/leadership_approval/Approval/boris.png",width = 15, height = 7.5, type = "cairo-png")



# CORBYN

poll <- read_csv("UK/leadership_approval/Approval/corbyn.csv")
d <- reshape2::melt(poll, id.vars="Date")
d$value<-as.numeric(d$value)/100
d$value<-formattable::percent(d$value)
...
ggsave(plot=plot, file="UK/leadership_approval/Approval/corbyn.png",width = 15, height = 7.5, type = "cairo-png")
