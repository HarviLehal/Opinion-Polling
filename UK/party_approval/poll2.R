...
poll <- read_csv("UK/party_approval/net_approval2.csv")
...
plot1<-ggplot(data=d,aes(x=Date,y=value, colour=variable, group=variable)) +
  ...
  ggtitle("Undecided/Don't Know Polling by Party")
plot1
...
plot
ggsave(plot=plot, file="UK/party_approval/plot2.png",width = 20, height = 7.5, type = "cairo-png")
