...
plot1<-ggplot(data=d,aes(x=Date,y=value, colour=variable, group=variable)) +
  ...
  scale_color_manual(values = c("#decb10","#0087DC","#E4003B","#528D6B","#FAA61A","#005eb8","#12B6CF"))+
  theme_minimal()+
...
plot3<-ggplot(data=d4, aes(x=variable, y=value,fill=interaction(Date,variable), group=Date )) +
  ...
  scale_fill_manual(values = c("#ede480","#decb10","#77c0ed","#0087DC","#f27999","#E4003B",
                               "#9dc7af","#528D6B","#fcd38b","#FAA61A","#669ed4","#005eb8","#80dae8","#12B6CF"))+
...
ggsave(plot=plot1a, file="UK/Subnational/Scotland/plot_Holyrood_Regional_ma.png",width = 15, height = 7.5, type = "cairo-png")
ggsave(plot=plot2a, file="UK/Subnational/Scotland/plot_Holyrood_Regional.png",width = 15, height = 7.5, type = "cairo-png")
