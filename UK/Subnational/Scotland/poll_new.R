...
py_run_file("UK/Subnational/Scotland/data3.py")
poll <- read_csv("UK/Subnational/Scotland/poll_new.csv")
...
plot1<-ggplot(data=d,aes(x=Date,y=value, colour=variable, group=variable)) +
  ...
  ggtitle('Opinion Polling for the Next United Kingdom General Election in Scotland')
...
plot4<-ggplot(data=d3, aes(x=variable, y=value,fill=interaction(Date,variable), group=Date )) +
  ...
  scale_fill_manual(values = c("#dd6666","#c70000","#f9ea66","#f5dc00",
                               "#66add3","#0077b6","#ec9e66","#e05e00",
                               "#80dae8","#12B6CF","#85c780","#33a22b"))+
...
ggsave(plot=plot1a, file="UK/Subnational/Scotland/plot1_Westminster_new.png",width = 20, height = 7.5, type = "cairo-png")
ggsave(plot=plot2a, file="UK/Subnational/Scotland/plot2_Westminster_new.png",width = 20, height = 7.5, type = "cairo-png")
