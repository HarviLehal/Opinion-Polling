...
wikiurl="https://en.wikipedia.org/wiki/Opinion_polling_for_the_next_Senedd_election"
...
headers = ['Date', 'Lab', 'Con', 'Plaid Cymru', 'Green', 'Lib Dem', 'Reform']
parties = ['Lab', 'Con', 'Plaid Cymru', 'Green', 'Lib Dem', 'Reform']
d = {}
for i in range(2):
  ...
  if i == 0:
    ...
    d[i] = d[i].drop(["Pollster", "Client", "Sample size", "Others", "Lead","AWA"], axis=1)
  d[i].columns = headers
