...
# ggsave(plot=plot2, file="UK/general_polling/plot2.png",width = 15, height = 7.5, type = "cairo-png")
...
ggsave(plot=plot3, file="UK/general_polling/plot3.png",width =12 , height = 6)
...
ggsave(plot=plot1a, file="UK/general_polling/plot1.png",width = 15, height = 7.5, type = "cairo-png")
ggsave(plot=plot2a, file="UK/general_polling/plot2.png",width = 15, height = 7.5, type = "cairo-png")
