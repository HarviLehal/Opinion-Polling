...
py_run_file("Spanish_Elections/Castilla La Mancha/data.py")
poll <- read_csv("Spanish_Elections/Castilla La Mancha/poll.csv")
...
ggsave(plot=plot1, file="Spanish_Elections/Castilla La Mancha/plot1.png",width = 15, height = 7.5, type = "cairo-png")
...
ggsave(plot=plot2, file="Spanish_Elections/Castilla La Mancha/plot2.png",width = 15, height = 7.5, type = "cairo-png")
...
ggsave(plot=plot3, file="Spanish_Elections/Castilla La Mancha/plot3.png",width = 15, height = 7.5, type = "cairo-png")
