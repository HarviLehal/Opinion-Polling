...
py_run_file("Spanish_Elections/Asturia/data.py")
poll <- read_csv("Spanish_Elections/Asturia/poll.csv")
...
plot1<-ggplot(data=d,aes(x=Date,y=value, colour=variable, group=variable)) +
  geom_point(size=0.5) +
  scale_color_manual(values = c("#EF1C27","#1D84CE","#EB6109","#10286B","#63BE21", "#7B4977"))+
  bbplot::bbc_style()+
...
ggsave(plot=plot1, file="Spanish_Elections/Asturia/plot1.png",width = 15, height = 7.5, type = "cairo-png")
...
ggsave(plot=plot2, file="Spanish_Elections/Asturia/plot2.png",width = 15, height = 7.5, type = "cairo-png")
...
ggsave(plot=plot3, file="Spanish_Elections/Asturia/plot3.png",width = 15, height = 7.5, type = "cairo-png")
