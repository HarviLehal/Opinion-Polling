...
py_run_file("Spanish_Elections/Cantabria/data.py")
poll <- read_csv("Spanish_Elections/Cantabria/poll.csv")
...
plot1<-ggplot(data=d,aes(x=Date,y=value, colour=variable, group=variable)) +
  geom_point(size=0.5) +
  scale_color_manual(values = c('#C2CE0C',"#1D84CE","#EF1C27","#EB6109","#63BE21","#7B4977"))+
  bbplot::bbc_style()+
...
ggsave(plot=plot1, file="Spanish_Elections/Cantabria/plot1.png",width = 15, height = 7.5, type = "cairo-png")
...
ggsave(plot=plot2, file="Spanish_Elections/Cantabria/plot2.png",width = 15, height = 7.5, type = "cairo-png")
...
ggsave(plot=plot3, file="Spanish_Elections/Cantabria/plot3.png",width = 15, height = 7.5, type = "cairo-png")
