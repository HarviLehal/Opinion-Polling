...
wikiurl="https://en.wikipedia.org/wiki/2023_Cantabrian_regional_election"
...
data22 = df0.drop(["Polling firm/Commissioner", "Sample size", "Turnout", "Lead", "Unnamed: 12_level_0"], axis=1)
headers = ['Date', 'PRC', 'PP', 'PSOE', 'Cs', 'VOX', 'PodemosA', 'PodemosB', 'PodemosC']
parties = ['PRC', 'PP', 'PSOE', 'Cs', 'VOX', 'PodemosA', 'PodemosB', 'PodemosC']
...
print(data22)
data22.to_csv('Spanish_Elections/Cantabria/poll.csv', index=False)
