...
library(data.table)
library(hrbrthemes)
py_run_file("Canada/Provincial/Alberta/data.py")
poll <- read_csv("Canada/Provincial/Alberta/poll.csv")
...
plot1<-ggplot(data=d,aes(x=Date,y=value, colour=variable, group=variable)) +
  ...
  ggtitle('Opinion Polling for the Next Alberta general election')
...
plot2<-ggplot(data=d3, aes(x=variable, y=value,fill=interaction(Date,variable), group=Date ))+
  ...
  scale_fill_manual(values = c("#669eb1","#005d7d","#ffc266","#ff9900","#6bc4ea","#089cdc"))+
