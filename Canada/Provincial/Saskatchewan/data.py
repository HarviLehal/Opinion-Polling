...
wikiurl="https://en.wikipedia.org/wiki/2024_Saskatchewan_general_election"
...
headers = ['1','2','Date','3','SP','NDP','Buffalo','Green','PC','Progress','United','4','5','6','7','8']
parties = ['SP','NDP','Buffalo','Green','PC','Progress','United']
...
D.to_csv('Canada/Provincial/Saskatchewan/poll.csv', index=False)
