...
wikiurl="https://en.wikipedia.org/wiki/2024_Nova_Scotia_general_election"
...
headers = ['1','Date','2','PC','Libéral','NDP','Vert','Autres','3','4','5','6']
parties = ['PC','Libéral','NDP','Vert','Autres']
drops = ['1','2','3','4','5','6']
d = {}
for i in range(1):
...
D.to_csv('Canada/Provincial/Nova Scotia/poll.csv', index=False)
