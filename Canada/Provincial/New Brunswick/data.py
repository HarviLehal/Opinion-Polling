...
wikiurl="https://en.wikipedia.org/wiki/2024_New_Brunswick_general_election"
...
headers = ['1','Date','2','PC','Liberal','Green','PA','NDP','3','4','5','6']
parties = ['PC','Liberal','Green','PA','NDP']
drops = ['1','2','3','4','5','6']
d = {}
for i in range(1):
...
D.to_csv('Canada/Provincial/New Brunswick/poll.csv', index=False)
