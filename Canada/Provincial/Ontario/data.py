...
wikiurl="https://en.wikipedia.org/wiki/44th_Ontario_general_election"
...
headers = ['1','Date','2','PC','NPD','Libéral','Vert','Autres','3','4','5','6']
parties = ['PC','NPD','Libéral','Vert','Autres']
drops = ['1','2','3','4','5','6']
d = {}
for i in range(1):
