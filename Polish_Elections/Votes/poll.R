...
py_run_file("Polish_Elections/Votes/data.py")
poll <- read_csv("Polish_Elections/Votes/poll.csv")
...
ggsave(plot=plot, file="Polish_Elections/Votes/plot.png",width = 15, height = 7.5, type = "cairo-png")
