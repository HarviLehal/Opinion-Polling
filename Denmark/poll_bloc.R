...
poll <- read_csv("Denmark/poll_bloc.csv")
...
plot1<-ggplot(data=d,aes(x=Date,y=value, colour=variable, group=variable)) +
  ...
  scale_color_manual(values = c("#c82518","#b48cd2","#01438e"))+
  ...
  ggtitle('Red-Blue Bloc Seat Projections for the Next Danish General Election')
...
ggsave(plot=plotA, file="Denmark/plot_bloc.png",width = 20, height = 10, type="cairo-png")

ggsave(plot=plotB, file="Denmark/plot_bloc_ma.png",width = 20, height = 10, type="cairo-png")
