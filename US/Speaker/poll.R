...
ggsave(plot=plot, file="US/Speaker/plot.png",width = 7.5, height = 10, type = "cairo-png")
...
ggsave(plot=plot2, file="US/Speaker/plot2.png",width = 7.5, height = 10, type = "cairo-png")
...
ggsave(plot=plot3, file="US/Speaker/plot3.png",width = 15, height = 7.5, type = "cairo-png")
