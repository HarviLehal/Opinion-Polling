...
data23 = data23[data23['AKP'] != data23['GP']]
...
data21 = data21[data21['AKP'] != data21['MHP']]
...
headers = ['Date', 'AKP', 'CHP1', 'CHP2', 'CHP3', 'CHP4', 'HDP1', 'HDP2', 'İYİ', 'MHP', 'DEVA', 'GP', 'SAADET']
parties = ['AKP', 'CHP1', 'CHP2', 'CHP3', 'CHP4', 'HDP1', 'HDP2', 'İYİ', 'MHP', 'DEVA', 'GP', 'SAADET']
...
parties = ['AKP', 'İYİ', 'MHP', 'DEVA', 'GP', 'SAADET','CHP', 'HDP']
for z in parties:
...
headers = ['Date', 'AKP', 'CHP1', 'CHP2', 'CHP3', 'CHP4', 'HDP', 'İYİ', 'MHP', 'DEVA', 'GP', 'SAADET']
parties = ['AKP', 'CHP1', 'CHP2', 'CHP3', 'CHP4', 'HDP', 'İYİ', 'MHP', 'DEVA', 'GP', 'SAADET']
CHP = ['CHP1', 'CHP2', 'CHP3', 'CHP4']
data19.columns = headers  
data19 = data19[data19['AKP'] != data19['MHP']]
