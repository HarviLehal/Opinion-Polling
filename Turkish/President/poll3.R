...
poll <- read_csv("Turkish/President/poll3.csv")
...
ggsave(plot=plot, file="Turkish/President/plot3.png",width = 15, height = 7.5, type = "cairo-png")
ggsave(plot=plot, file="Turkish/President/plot3.svg",width = 15, height = 7.5)
aaa=readLines("Turkish/President/plot3.svg",-1)
bbb <- gsub(".svglite ", "", aaa)
writeLines(bbb,"Turkish/President/plot3.svg")
