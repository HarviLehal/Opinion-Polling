...
py_run_file("UK_Elections/leadership_approval/data.py")
boris1 <- read_csv("UK_Elections/leadership_approval/boris.csv")
sunak1 <- read_csv("UK_Elections/leadership_approval/sunak.csv")
truss1 <- read_csv("UK_Elections/leadership_approval/truss.csv")
...
ggsave(plot=plot1, file="UK_Elections/leadership_approval/plot1.png",width = 15, height = 7.5, type = "cairo-png")
...
ggsave(plot=plot2, file="UK_Elections/leadership_approval/plot2.png",width = 15, height = 7.5, type = "cairo-png")
...
ggsave(plot=plot3, file="UK_Elections/leadership_approval/plot3.png",width = 15, height = 7.5, type = "cairo-png")
...
ggsave(plot=plot1b, file="UK_Elections/leadership_approval/plot1b.png",width = 15, height = 7.5, type = "cairo-png")
...
ggsave(plot=plot2b, file="UK_Elections/leadership_approval/plot2b.png",width = 15, height = 7.5, type = "cairo-png")
...
ggsave(plot=plot1s, file="UK_Elections/leadership_approval/plot1s.png",width = 15, height = 7.5, type = "cairo-png")
...
ggsave(plot=plot2s, file="UK_Elections/leadership_approval/plot2s.png",width = 15, height = 7.5, type = "cairo-png")
...
ggsave(plot=plot1t, file="UK_Elections/leadership_approval/plot1t.png",width = 15, height = 7.5, type = "cairo-png")
...
ggsave(plot=plot2t, file="UK_Elections/leadership_approval/plot2t.png",width = 15, height = 7.5, type = "cairo-png")
