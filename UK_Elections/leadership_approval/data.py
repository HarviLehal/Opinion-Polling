...
sunak.to_csv('UK_Elections/leadership_approval/sunak.csv', index=False)
boris.to_csv('UK_Elections/leadership_approval/boris.csv', index=False)
truss.to_csv('UK_Elections/leadership_approval/truss.csv', index=False)
