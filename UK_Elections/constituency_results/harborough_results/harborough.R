...
poll <- read_csv("UK_Elections/constituency_results/harborough_results/harborough.csv")
...
ggsave(plot=plot, file="UK_Elections/constituency_results/harborough_results/plot.png",width = 15, height = 7.5, type = "cairo-png")
