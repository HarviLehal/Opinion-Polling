...
plot1<-ggplot(data=d,aes(x=Date,y=value, colour=variable, group=variable)) +
  ...
  scale_color_manual(values = c("#ff66ff","#ff9900","#202056",
                                "#00adef","#8b0000","#ff0000",
                                "#0093dd","#008080","#c2d216","#3777bc"))+
...
combined <-d2$value[d2$variable == "CDS-PP"]+d2$value[d2$variable == "PSD"]
d2$value[d2$variable == "AD"] <- combined

d3<-rbind(d2,d1)
d3<-d3[d3$variable!='CDS-PP',]
d3<-d3[d3$variable!='PSD',]
d3<-droplevels(d3)
#"#ffc266","#ff9900",
#"#66beeb","#0093dd"
plot2<-ggplot(data=d3, aes(x=variable, y=value,fill=interaction(Date,variable), group=Date )) +
  geom_bar(stat="identity",width=0.9, position=position_dodge())+
  scale_fill_manual(values = c("#ffa3ff","#ff66ff","#79799a","#202056",
                               "#66cef5","#00adef","#b96666","#8b0000",
                               "#ff6666","#ff0000","#66b3b3","#008080",
                               "#dae473","#c2d216","#87add7","#3777bc"))+
