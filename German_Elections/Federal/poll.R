...
library(data.table)
library(hrbrthemes)
py_run_file("German_Elections/Federal/data.py")
poll <- read_csv("German_Elections/Federal/poll.csv")
...
ggsave(plot=plot, file="German_Elections/Federal/plot.png",width = 15, height = 7.5, type="cairo-png")
