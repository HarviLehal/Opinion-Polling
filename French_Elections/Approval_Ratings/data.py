...
macron.to_csv('French_Elections/Approval_Ratings/macron.csv', index=False)
borne.to_csv('French_Elections/Approval_Ratings/borne.csv', index=False)
castex.to_csv('French_Elections/Approval_Ratings/castex.csv', index=False)
philippe.to_csv('French_Elections/Approval_Ratings/philippe.csv', index=False)
