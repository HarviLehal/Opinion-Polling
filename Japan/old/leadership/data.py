...
headers = ['Date','Ishiba','Koizumi','Kono','Takaichi','Kamikawa','Kobayashi','Motegi','Hayashi','Kato','Other','Undecided']
parties = ['Ishiba','Koizumi','Kono','Takaichi','Kamikawa','Kobayashi','Motegi','Hayashi','Kato','Other','Undecided']
d = {}
...
print(D)
parties = ['Ishiba','Koizumi','Kono','Takaichi','Kamikawa','Kobayashi','Motegi','Hayashi','Kato','Other']
D[parties] = D[parties].div(D['decided'], axis=0)*100
