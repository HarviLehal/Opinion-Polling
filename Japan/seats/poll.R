...
start<-as.Date("29 06 2025", "%d %m %Y")
old<-min(d$Date)
election<-as.Date("20 07 2025", "%d %m %Y")
...
plot1<-ggplot(data=d[d$Date!=old,],aes(x=Date,y=value, colour=variable, group=variable)) +
  ...
  scale_color_manual(values = c("#3ca324","#184589","#b8ce43","#ffba00",
                                "#f95580","#ed008c","#db001c","#ed7301",
                                "#0b80db","#1ca9e9","#999999"
  ))+
  ...
  ggtitle('Seat Projection for the 2025 Japanese House of Councillors Election')
plot1 
...
plot2<-ggplot(data=d3, aes(x=variable, y=value,fill=interaction(Date,variable), group=Date )) +
  ...
  scale_fill_manual(values = c("#77bf66","#3ca324","#748fb8","#184589",
                               "#d4e28e","#b8ce43","#ffd666","#ffba00",
                               "#fb99b3","#f95580","#f466ba","#ed008c",
                               "#e96677","#db001c","#f4ab67","#ed7301",
                               "#6db3e9","#0b80db","#77cbf2","#1ca9e9","#cccccc","#999999"))+
