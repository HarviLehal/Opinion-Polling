...
election<-as.Date("8 06 2024", "%d %m %Y")
...
plot2<-ggplot(data=d3, aes(x=variable, y=value,fill=interaction(Date,variable), group=Date )) +
  ...
  scale_fill_manual(values = c("#68b568","#048404","#f5777d","#ef1c27","#f8d976","#f4c01a","#68b5ea","#0484dc",
                               "#6888a6","#03386a","#d78598","#bc3454","#d27174","#b41317","#6688cc","#0039aa",
                               "#6a97aa","#075271","#fae37c","#f6d025","#fde568","#fcd404","#e58fba","#d4448c"))+
  ...
  geom_text(aes(label = ifelse(d3$Date == max(d3$Date),
                               ifelse(is.na(d3$value)==FALSE,paste(formattable::percent(d3$value)),""),
                               ifelse(is.na(d3$value)==FALSE,paste("(",formattable::percent(d3$value),")"),
                                      ifelse(d3$variable=='SUE','(3.1% from E+)',"New"))),y = 0),
