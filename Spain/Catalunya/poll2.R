...
library(data.table)
library(hrbrthemes)
poll <- read_csv("Spain/Catalunya/seats.csv")
...
ggsave(plot=plot, file="Spain/Catalunya/seats.png",width = 15, height = 7.5, type="cairo-png")

plot<-ggarrange(plot1a, plot2,ncol = 2, nrow = 1,widths=c(2,0.6))
plot

ggsave(plot=plot, file="Spain/Catalunya/seats_ma.png",width = 15, height = 7.5, type="cairo-png")