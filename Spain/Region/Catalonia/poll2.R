...
library(data.table)
library(hrbrthemes)
py_run_file("Spain/Region/Catalonia/data2.py")
poll <- read_csv("Spain/Region/Catalonia/poll2.csv")
...
plot1<-ggplot(data=d,aes(x=Date,y=value, colour=variable, group=variable)) +
  ...
  ggtitle('Seat Projection For Next Catalan Regional Election')
...
ggsave(plot=plot, file="Spain/Region/Catalonia/plot2.png",width = 15, height = 7.5, type="cairo-png")
