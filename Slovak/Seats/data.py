...
headers = ['drop1','Date','drop2','Smer*','PS','Hlas*','OLaNOap','KDH','SASKA','SNS*','Republika','Alliance','drop5','drop3','drop4']
parties = ['Smer*','PS','Hlas*','OLaNOap','KDH','SASKA','SNS*','Republika','Alliance']
