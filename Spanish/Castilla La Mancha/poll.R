...
py_run_file("Spanish/Castilla La Mancha/data.py")
poll <- read_csv("Spanish/Castilla La Mancha/poll.csv")
...
ggsave(plot=plot, file="Spanish/Castilla La Mancha/plot.png",width = 15, height = 7.5, type = "cairo-png")
