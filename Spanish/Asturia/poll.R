...
py_run_file("Spanish/Asturia/data.py")
poll <- read_csv("Spanish/Asturia/poll.csv")
...
ggsave(plot=plot, file="Spanish/Asturia/plot.png",width = 15, height = 7.5, type = "cairo-png")
