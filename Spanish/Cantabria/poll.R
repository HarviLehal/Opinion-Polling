...
py_run_file("Spanish/Cantabria/data.py")
poll <- read_csv("Spanish/Cantabria/poll.csv")
...
ggsave(plot=plot, file="Spanish/Cantabria/plot.png",width = 15, height = 7.5, type = "cairo-png")
