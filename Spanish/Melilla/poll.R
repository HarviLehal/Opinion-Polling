...
py_run_file("Spanish/Melilla/data.py")
poll <- read_csv("Spanish/Melilla/poll.csv")
...
ggsave(plot=plot, file="Spanish/Melilla/plot.png",width = 15, height = 7.5, type = "cairo-png")
